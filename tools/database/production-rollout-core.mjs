...
/**
 * Validate the production player-settings schema as one of three complete
 * states: 0 = absent, 1 = base table only, 2 = base plus locale. Any partial
 * or out-of-order state is unsafe and rejected.
 */
