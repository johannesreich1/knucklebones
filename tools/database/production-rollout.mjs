...
function usage(message, code = 64) {
  ...
  console.error('Usage: mise exec -- node --experimental-strip-types tools/database/production-rollout.mjs <settings-locale|match-command-retention|rune-trial|ladder-streak-baselines> [--apply]');
