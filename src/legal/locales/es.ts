  ...
  pages: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: 'Conservación y eliminación', blocks: [p('Las cuentas de invitado o recuperadas permanecen hasta su eliminación. Tras resolver una partida activa, la eliminación borra perfil, ajustes, filas de clasificación y cola e historial de partidas y movimientos. Si está vinculado el inicio de sesión con Apple, la credencial de revocación guardada se usa para retirar el acceso; los fallos temporales se reintentan y, si no es posible, la aplicación muestra instrucciones manuales. Las preferencias y estadísticas locales siguen en el dispositivo hasta borrar los datos de la app o del sitio. Los registros de seguridad se conservan {{securityLogRetention}} y las copias de seguridad {{backupRetention}}.')] },
