  ...
  pages: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { heading: 'Destinatari, regioni e trasferimenti', blocks: [p('Supabase fornisce autenticazione, database, Edge Functions e Realtime. La regione del database è {{supabaseDatabaseRegion}} e quella delle Edge Functions è {{supabaseFunctionsRegion}}.'), p('Cloudflare Pages distribuisce la PWA ospitata. L’ambito di trattamento rilevante è: {{cloudflareProcessingScope}}.'), p('Le garanzie applicabili ai trasferimenti internazionali sono: {{transferSafeguards}}. L’app nativa carica invece i file web inclusi nel pacchetto.'), p('Non integriamo SDK pubblicitari o di analisi comportamentale né script remoti di marketing o analisi. I fornitori dell’infrastruttura possono comunque creare log operativi, di sicurezza e di accesso.')] },
        ...
        { heading: 'Conservazione ed eliminazione', blocks: [p('Gli account ospite o recuperati restano fino all’eliminazione. Dopo la conclusione di un’eventuale partita attiva, l’eliminazione rimuove profilo, impostazioni, classifica, coda e cronologia di partite e mosse. Preferenze e statistiche locali restano finché non cancelli i dati dell’app o del sito. I log di sicurezza sono conservati {{securityLogRetention}} e i backup {{backupRetention}}.')] },
