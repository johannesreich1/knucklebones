...
export const esLearn = {
  ...
  rules: {
    ...
    runes: {
      heading: 'Runas',
      body: 'Las partidas sin conexión pueden dar una <b>runa</b> junto al dado. En multijugador local siempre están disponibles las seis; contra la IA, solo puedes usar las runas conseguidas en línea. <b>Ninguna</b> es la opción predeterminada; las opciones con nombre y <b>aleatoria</b> dan runas iguales a ambos jugadores, mientras <b>aleatoria 2</b> les da runas distintas. En el <b>Ritual de Runas</b>, ambos ven las mismas tres runas, cada uno elige una en secreto y las elecciones se revelan a la vez. Solo el Ritual de Runas se detiene antes del duelo para elegir y revelar runas. Gana una partida clasificatoria en el Ritual de Runas para conseguir la runa elegida; el Ritual ignora el equipo. Las partidas clasificatorias normales usan la runa equipada después de que ese jugador alcance PLATA por primera vez; quien nunca haya llegado a PLATA o deje el espacio vacío juega sin runa. Pulsa una runa que actúe sobre el dado para usarla al instante; arrastra o toca una runa de columna y luego una columna iluminada. Usar una runa no es una jugada, así que después aún colocas el dado. La lista completa está en <b>CÓMO JUGAR → RUNAS</b>.',
    },
    twoPlayers: {
