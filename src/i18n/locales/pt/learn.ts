...
export const ptLearn = {
  ...
  rules: {
    ...
    runes: {
      heading: 'Runas',
      body: 'Partidas offline podem dar uma <b>runa</b> ao lado do dado. No multijogador local, as seis estão sempre disponíveis; contra a IA, só é possível usar runas coletadas online. <b>Nenhuma</b> é o padrão; opções nomeadas e <b>aleatória</b> dão runas iguais aos dois jogadores, enquanto <b>aleatória 2</b> dá runas diferentes. No <b>Ritual das Runas</b>, ambos veem as mesmas três runas, cada um escolhe uma em segredo e as escolhas são reveladas ao mesmo tempo. Só o Ritual das Runas pausa antes do duelo para escolher e revelar runas. Vença uma partida ranqueada no Ritual das Runas para coletar a runa escolhida; o Ritual ignora o equipamento. Partidas ranqueadas comuns usam a runa equipada depois que o jogador alcança PRATA uma vez; quem nunca chegou a PRATA ou deixou o espaço vazio joga sem runa. Pressione uma runa que age no dado para usá-la de imediato; arraste ou toque numa runa de coluna e depois numa coluna iluminada. Usar uma runa não é uma jogada, então você ainda coloca o dado. A lista completa está em <b>COMO JOGAR → RUNAS</b>.',
    },
    twoPlayers: {
