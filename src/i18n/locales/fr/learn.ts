...
export const frLearn = {
  ...
  rules: {
    ...
    runes: {
      heading: 'Runes',
      body: 'Hors ligne, une <b>rune</b> peut être distribuée près du dé courant. En multijoueur local, les six sont toujours disponibles ; contre l’IA, seules les runes collectées en ligne peuvent être utilisées. Le choix <b>Aucune</b> est sélectionné par défaut ; les runes nommées et <b>aléatoire</b> donnent la même rune aux deux joueurs, tandis qu’<b>aléatoire 2</b> leur en donne des différentes. Dans le <b>Rituel des runes</b>, les deux joueurs voient les mêmes trois runes, chacun en choisit une en secret et les choix sont révélés simultanément. Seul le Rituel des runes comporte ce choix et cette révélation avant le duel. Gagnez une partie classée en Rituel des runes pour collecter la rune choisie ; le Rituel ignore l’équipement. Les parties classées ordinaires utilisent la rune équipée de chaque joueur dès que celui-ci a atteint ARGENT une première fois ; un joueur qui n’a jamais atteint ARGENT ou qui laisse l’emplacement vide joue sans rune. Appuyez sur une rune qui agit sur votre dé pour l’utiliser immédiatement ; glissez ou touchez une rune de colonne sur une colonne illuminée. Un usage n’est pas un coup : votre dé est toujours posé ensuite. La liste complète se trouve sous <b>COMMENT JOUER → RUNES</b>.',
    },
    twoPlayers: {
