export const enGame = {
  ...
  runeTrial: {
    ...
    setupOwnChoice: 'In Rune Ritual, both players see the same three runes, each secretly chooses one, and both choices are revealed together.',
    lockTrialReachIvory: 'Reach IVORY to unlock Rune Ritual.',
    lockCollectThree: 'Collect three runes to unlock Rune Ritual versus AI.',
    lockCollectTwo: 'Collect two runes to unlock this choice versus AI.',
    lockReachIvory: 'Reach IVORY, then win this rune in Rune Ritual.',
