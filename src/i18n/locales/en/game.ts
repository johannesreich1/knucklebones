export const enGame = {
  ...
  result: {
    ...
    sessionDuo: 'SESSION  P1 {{p1}} – {{p2}} P2',
    sessionDuoDraws_one: 'SESSION  P1 {{p1}} – {{p2}} P2  ·  {{formatted}} draw',
    sessionDuoDraws_other: 'SESSION  P1 {{p1}} – {{p2}} P2  ·  {{formatted}} draws',
    sessionCpu: 'SESSION  {{wins}}–{{losses}}',
    sessionCpuDraws: 'SESSION  {{wins}}–{{losses}}–{{count}} D',
