export const enOnline = {
  ...
  profile: {
    ...
    randomEquipped: 'RANDOM RUNE MODE — A random owned rune is used for each ranked match from SILVER · not in Rune Ritual',
    randomEquippedWaiting: 'RANDOM RUNE MODE — Reach SILVER to use a random owned rune for each ranked match · not in Rune Ritual',
    equippedMeta: 'Used in ranked from SILVER · not in Rune Ritual',
    equippedWaiting: 'Reach SILVER to use it in ranked · not in Rune Ritual',
    seatEmpty: 'NO RUNE',
    seatPick: 'EQUIPPED RUNE',
    seatPickDetail: 'Equip one unlocked rune, or let RANDOM RUNE MODE draw a random owned rune for each ranked match from SILVER. Rune Ritual uses its own choice.',
  },
  avatar: {
  ...
  groupTransition: {
    dialogLabel: 'Group transition from {{from}} to {{to}}',
    newGroup: 'NEW GROUP',
    groupChanged: 'GROUP CHANGED',
    promotedTo: 'PROMOTED TO',
    demotedTo: 'DEMOTED TO',
    promotionBody: 'A new material and a wider ring. Your climb continues.',
    ...
    runeActiveTitle: 'YOUR RUNE IS ACTIVE',
    runeActiveBody: '{{rune}} now joins your ordinary ranked matches from SILVER.',
    randomActiveBody: 'From SILVER, Random rune mode draws one of your runes for each ordinary ranked match.',
    runeRestingTitle: 'YOUR RUNE IS RESTING',
    runeRestingBody: '{{rune}} stays equipped below SILVER. Your permanent modes and Rune Ritual remain.',
    randomRestingBody: 'Random rune mode stays equipped below SILVER. Your permanent modes and Rune Ritual remain.',
  },
  errors: {
