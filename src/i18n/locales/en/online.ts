export const enOnline = {
  ...
  groupTransition: {
    ...
    runesActiveTitle: 'RUNES CAN NOW BE ACTIVE',
    runesActiveBody: 'From the SILVER league, a rune you equip can join ordinary ranked matches.',
    runesRestingTitle: 'RUNES ARE RESTING',
    runesRestingBody: 'Below the SILVER league, equipped runes rest. Your collection remains yours.',
