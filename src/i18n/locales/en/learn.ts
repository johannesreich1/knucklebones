export const enLearn = {
  ...
  rules: {
    ...
    runes: {
      heading: 'Runes',
      body: 'Offline games can deal a <b>rune</b> beside the die in play. Local multiplayer always has all six; versus AI, you can use only runes collected online. <b>None</b> is the default; named picks and <b>random</b> give both players matching runes, while <b>random 2</b> gives them different ones. In <b>Rune Ritual</b>, both players see the same three runes, each secretly chooses one, and both choices are revealed together. Win a ranked Rune Ritual to collect your chosen rune; other ranked modes ignore equipped runes. Press a rune that acts on your die to cast it immediately; drag or tap a column-targeting rune onto a lit column. A cast is not a move, so your die still lands afterwards. The full roster lives under <b>HOW TO PLAY → RUNES</b>.',
    },
    twoPlayers: {
      heading: 'Two players',
