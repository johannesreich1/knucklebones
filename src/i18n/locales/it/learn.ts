...
export const itLearn = {
  ...
  rules: {
    ...
    runes: {
      heading: 'Rune',
      body: 'Le partite offline possono dare una <b>runa</b> accanto al dado. In multigiocatore locale sono sempre disponibili tutte e sei; contro l’IA puoi usare solo le rune raccolte online. <b>Nessuna</b> è la scelta predefinita; quelle con nome e <b>casuale</b> danno la stessa runa a entrambi, mentre <b>casuale 2</b> ne dà due diverse. Nel <b>Rituale delle Rune</b>, entrambi vedono le stesse tre rune, ciascuno ne sceglie una in segreto e le scelte vengono rivelate contemporaneamente. Solo il Rituale delle Rune prevede questa scelta e rivelazione prima del duello. Vinci una partita classificata nel Rituale delle Rune per raccogliere la runa scelta; il Rituale ignora l’equipaggiamento. Le partite classificate normali usano la runa equipaggiata di ciascun giocatore dopo che ha raggiunto ARGENTO almeno una volta; chi non ha mai raggiunto ARGENTO o lascia vuoto lo slot gioca senza rune. Premi una runa che agisce sul dado per usarla subito; trascina o tocca una runa di colonna e poi una colonna illuminata. Usare una runa non è una mossa, quindi dopo piazzi ancora il dado. La lista completa è in <b>COME SI GIOCA → RUNE</b>.',
    },
    twoPlayers: {
