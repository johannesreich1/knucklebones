...
export const deLearn = {
  ...
  rules: {
    ...
    runes: {
      heading: 'Runen',
      body: 'Offline-Spiele können eine <b>Rune</b> neben dem aktuellen Würfel austeilen. Im lokalen Mehrspielermodus sind immer alle sechs verfügbar; gegen die KI kannst du nur online gesammelte Runen nutzen. <b>Keine</b> ist Standard; benannte Runen und <b>Zufall</b> geben beiden Spielern dieselbe Rune, <b>Zufall 2</b> gibt ihnen verschiedene. Im <b>Runenritual</b> sehen beide dieselben drei Runen, wählen heimlich je eine aus und decken beide gleichzeitig auf. Nur im Runenritual wird vor dem Duell pausiert, um Runen zu wählen und aufzudecken. Gewinne ein Runenritual im Ranglistenmodus, um deine gewählte Rune zu sammeln; das Runenritual ignoriert die Ausrüstung. Normale Ranglistenspiele nutzen die ausgerüstete Rune jedes Spielers, sobald dieser einmal SILBER erreicht hat; wer SILBER nie erreicht oder den Ausrüstungsplatz leer lässt, spielt ohne Rune. Tippe eine Rune, die auf deinen Würfel wirkt, um sie sofort einzusetzen; ziehe oder tippe eine Spaltenrune auf eine leuchtende Spalte. Ein Einsatz ist kein Zug, dein Würfel landet also danach noch. Die vollständige Übersicht findest du unter <b>SPIELREGELN → RUNEN</b>.',
    },
    twoPlayers: {
