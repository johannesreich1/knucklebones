...
<div class="ov paged" id="ovPractice">
  ...
  <div class="pbody">
    ...
    <div class="playbar">
      <button class="btn primary" id="btnPlay"><span class="btn-leading-icon" data-icon="play" aria-hidden="true">${chromeIcon('play', 25)}</span><span class="btn-label">Play</span></button>
