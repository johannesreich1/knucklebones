...
export function runeSeatPickerMarkup(
  ...
  const randomChoice = random ? '' : `<div class="seatmode-random">`
    + `<button type="button" class="btn soft seatmode-random-action" id="accSeatRandom"`
    + ` data-equipment-kind="random" aria-pressed="false"`
