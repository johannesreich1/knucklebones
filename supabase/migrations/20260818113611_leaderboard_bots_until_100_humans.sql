-- An empty ladder is a worse lie than a populated one: while the human pool is
-- small, bots stand in it under their generated nicknames (indistinguishable by
-- design — they play, they rate, they lose). The moment 100 real players have
-- ranked games, the ladder becomes human-only automatically, with no deploy.
