-- When matchmaking finds no free bot within Elo range of the human, it mints
-- one: the same auth-user pattern as the 0007 pool seed, the signup trigger
-- hands it a generated nickname, then it is flagged and rated. Service-only.
