-- Applied 2026-08-16 via MCP (pvp_pivot_v2). PvP pivot: solo/AI games are
-- never ranked. Ranked = online PvP with bot backfill; Elo ladder; bots
-- flagged and never listed. Supersedes the solo-ranked pipeline (0001).
...
create table public.matches (
  ...
  turn smallint not null default 1 check (turn in (0,1)),
