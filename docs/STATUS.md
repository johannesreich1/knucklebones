...
| **CI** | GitHub Actions: build + full test gate (31 suites) on every push — green through current `main`. (The count said 27 until 2026-08-22, when `tests/run-all.mjs` was counted and found to disagree — the runner is the truth.) |
