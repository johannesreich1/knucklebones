...
try {
  ...
  await pool([
    ...
    ...['architecture', 'preferences', 'rune-collection-cache', 'rune-collection-guard', 'local-options', 'trial-snapshot', 'i18n', 'i18n-catalog', 'i18n-length-report', 'legal', 'production-migrations', 'dice', 'match', 'modes', 'ranked-outcomes', 'ranked-actions', 'spells', 'scoring-ward', 'spell-ai', 'scoring-ward-ai', 'rune-matchups', 'rune-matchup-analysis', 'rune-ward-sensitivity', 'rune-sunder-sensitivity', 'online-api', 'gcauth', 'edge-handlers', 'edge-settlement', 'cssgraph', 'cssreach', 'design-library', 'ladder', 'ladderbench', 'botbench', 'fnsync', 'iosship', 'androidship', 'apple-identity', 'native-startup', 'live-safety', 'gate-lock'].map(node),
