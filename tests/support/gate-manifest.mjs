...
export const CI_SHARDS = Object.freeze({
  'ci-1': Object.freeze([
    ...
    'rune-collection-cache', 'ranked-outcomes',
  ]),
  'ci-2': Object.freeze([
    'test16', 'test11', 'spells-presentation', 'test7', 'test15',
  ...
  'ci-3': Object.freeze([
    ...
    'test23', 'botbench', 'test22', 'architecture', 'rune-ward-sensitivity',
    'preferences', 'i18n-catalog', 'edge-handlers', 'cssgraph', 'fnsync',
    'ladder', 'local-options', 'testupdate',
  ]),
  'ci-4': Object.freeze([
    'test20', 'test6', 'test9', 'spells-defense', 'test12', 'test17', 'test24',
