...
export const GATE_SUITES = Object.freeze([
  ...
  typed('architecture'),
  typed('preferences'),
  typed('progression-status-cache'),
  ...
  typed('match'),
  typed('modes'),
  typed('ranked-outcome-presentation'),
  typed('ranked-outcomes'),
  typed('group-transition'),
  typed('result-progression-copy'),
...
export const CI_SHARDS = Object.freeze({
  'ci-1': Object.freeze([
    ...
    'random-mode-dial', 'rune-collection-cache', 'progression-status-cache',
